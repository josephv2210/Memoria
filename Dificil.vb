Public Class Dificil
    ...
    Private Sub Img_Pareja7_1_Click(sender As Object, e As EventArgs) Handles Img_Pareja7_1.Click
        Pareja(Img_Pareja7_1, Img_Img7, Img_Pareja7_2)
    End Sub

    Private Sub Img_Pareja7_2_Click(sender As Object, e As EventArgs) Handles Img_Pareja7_2.Click
        Pareja(Img_Pareja7_2, Img_Img7, Img_Pareja7_1)
    End Sub

    Private Sub Img_Pareja8_1_Click(sender As Object, e As EventArgs) Handles Img_Pareja8_1.Click
        Pareja(Img_Pareja8_1, Img_Img8, Img_Pareja8_2)
    End Sub

    Private Sub Img_Pareja8_2_Click(sender As Object, e As EventArgs) Handles Img_Pareja8_2.Click
        Pareja(Img_Pareja8_2, Img_Img8, Img_Pareja8_1)
    End Sub

    Private Sub Img_Pareja9_1_Click(sender As Object, e As EventArgs) Handles Img_Pareja9_1.Click
        Pareja(Img_Pareja9_1, Img_Img9, Img_Pareja9_2)
    End Sub

    Private Sub Img_Pareja9_2_Click(sender As Object, e As EventArgs) Handles Img_Pareja9_2.Click
        Pareja(Img_Pareja9_2, Img_Img9, Img_Pareja9_1)
    End Sub

    Private Sub Dificil_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub Img_Pareja10_1_Click(sender As Object, e As EventArgs) Handles Img_Pareja10_1.Click
        Pareja(Img_Pareja10_1, Img_Img10, Img_Pareja10_2)
    End Sub

    Private Sub Img_Pareja10_2_Click(sender As Object, e As EventArgs) Handles Img_Pareja10_2.Click
        Pareja(Img_Pareja10_2, Img_Img10, Img_Pareja10_1)
    End Sub
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        ...
        If segundos2 = 1 Then
            ...
            Img_Pareja7_1.Image = Img_Estandar.Image
            Img_Pareja7_2.Image = Img_Estandar.Image
            Img_Pareja8_1.Image = Img_Estandar.Image
            Img_Pareja8_2.Image = Img_Estandar.Image
            Img_Pareja9_1.Image = Img_Estandar.Image
            Img_Pareja9_2.Image = Img_Estandar.Image
            Img_Pareja10_1.Image = Img_Estandar.Image
            Img_Pareja10_2.Image = Img_Estandar.Image
            segundos2 = 0
